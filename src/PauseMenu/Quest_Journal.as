...
class Quest_Journal extends MovieClip
{
	...
	function Quest_Journal()
	{
		...
		bTabsDisabled = false;
		iCurrentTab = Quest_Journal.PAGE_SYSTEM; //CrEaToXx: changed back to the way it was in legendary, opening the settings page, instead of the quest page when pressing ESC
	}
	...
	function OnShow(): Void
	{
      ...
      StatsTab.disableFocus = true;
      SystemTab.disableFocus = true;
      QuestsTab.disabled = false; //CrEaToXx: make sure quests tab is disabled OnShow! default is: false
	...
	{
		QuestsTab.disabled = abEnable; //CrEaToxx: make sure quests tab is disabled when exiting any other instance of main menu, org -> abEnable, modded -> true
